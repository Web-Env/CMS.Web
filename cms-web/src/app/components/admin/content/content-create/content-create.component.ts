...
export class ContentCreateComponent implements OnDestroy, OnInit {
    ...
    ngOnInit(): void {
        ...
        this.loadSectionsSubscription = this.actions$
            .pipe(ofType(SectionActions.LOAD_SECTIONS_SUCCESS))
        ...
        this.addContentSuccessSubscription = this.actions$
            .pipe(ofType(ContentActions.ADD_CONTENT_SUCCESS, ContentActions.UPDATE_CONTENT_SUCCESS))
            .subscribe(() => {
                if (this.saveClicked) {
        ...
        this.addContentFailureSubscription = this.actions$
            .pipe(ofType(ContentActions.ADD_CONTENT_FAILURE, ContentActions.UPDATE_CONTENT_FAILURE))
            .subscribe((data: any) => {
